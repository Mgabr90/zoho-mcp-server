...
async function testDispositionGlobal() {
    console.log('🔍 Testing disposition and sub-disposition as global fields...');
    ...
    console.log('✅ Server is ready. Testing global fields for disposition...');
...
testDispositionGlobal().catch(console.error); 